"""
Script to train an XGBoost Classifier with hyperparameter tuning using RandomizedSearchCV.
...
def train_and_evaluate(df, target_col, id_col):
    """
    Main training workflow for XGBoost with Hyperparameter Tuning.
    """
    ...
    # Tuning the 5 most important hyperparameters
    param_dist = {
    ...
    print_report("diagnosed_diabetes", "XGBoost (Tuned)", y_test, y_pred, cv_results)
...
if __name__ == "__main__":
    ...
    ID_COL = 'id'
    OUTPUT_FILENAME = "test_data_xgboost_output.csv"
